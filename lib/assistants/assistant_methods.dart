...
class AssistantMethods {
  static void readCurrentOnlineUserInfo() async {
    ...
    userRef.once().then((snap) {
      if (snap.snapshot.value != null) {
        ...
        print("DEBUG::: current userName : ${userModelCurrentInfo?.name}");
        print("DEBUG::: current email : ${userModelCurrentInfo?.email}");
      }
    });
  }
  ...
  static Future<String> searchAddressForGeographicCoOrdinates(
    ...
    print(requestResponse["results"]);
    print(requestResponse["error_message"]);
    print(requestResponse["REQUEST_DENIED"]);
